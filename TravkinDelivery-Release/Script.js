...
function Chooser(){
	...
	if (chooser == true){
		...
		let Name = event.target.parentNode.parentNode.children[0].innerText;    //Если выбираем, то выводится по параметрам поиска
...
setTimeout(Chooser, 2000);  //Как только загрузятся данные, чтобы в меню без выбора был топ-1 ресторан
